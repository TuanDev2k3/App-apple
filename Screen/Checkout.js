...
export default function Checkout(props) {
    ...
    const calculateTotal = () => {
        ...
        dataCart.map(product => {
            total += product.priceCart * product.quantity;
        });
        return total;
    };
    // ======= Don gio hang khi thanh toan thanh cong ========
    ...
    function ItemProduct({ item }) {
        return (
            <View key={item.idCart} style={styles.productContainer}>
                <Image source={{ uri: item.imageCart }} style={styles.productImage} />
                <View style={styles.productInfo}>
                    <Text style={styles.productName}>{item.nameCart}</Text>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Text style={styles.productPrice}>Price: ${item.priceCart} </Text>
                        <Text style={[styles.productPrice, { color: 'red', fontSize: 20 }]}>x{item.quantity}</Text>
                    </View>
                </View>
            </View>
        )
            ...
            (<View style={{ padding: 10 }}>
                ...
                <View style={{ width: ScreenWidth, marginTop: 20, paddingHorizontal: 5 }}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', marginVertical: 3, justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ color: '#5b5b5b' }}>${calculateTotal()}</Text>
                    </View>
                    <View style={{ display: 'flex', flexDirection: 'row', marginVertical: 3, justifyContent: 'space-between' }}>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', marginVertical: 3, justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ fontWeight: 500, color: 'red' }}>${calculateTotal() + ship}</Text>
                    </View>
            ...
            (<ScrollView style={styles.container}>
                ...
                <View style={{ display: 'flex', flexDirection: 'row' }}>
                    <View style={styles.inputContainername}>
                        ...
                        />
                        {(firstNameError) && <Text style={{ color: 'red' }}>  Invalid Last name</Text>}
                    </View>
                    <View style={styles.inputContainername}>
                        <TextInput
                        ...
                        />
                        {(lastNameError) && <Text style={{ color: 'red' }}>  Invalid Last name</Text>}
                    </View>
                </View>
